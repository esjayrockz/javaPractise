...
public class KruskalAlgorithm
{
    ...
    public static final double MAX_VALUE = 999.00;
    private int visited[];
    ...
    public void kruskalAlgorithm(double adjacencyMatrix[][])
    {
        ...
        System.out.println("Representing all components of the minimum spanning forest in one matrix ");
    ...
    public static void kruskal(double adjacency_matrix_old[][], int number_of_vertices)
    {
        System.out.println("Implementing Kruskal's algorithm \n");

        Scanner scan = new Scanner(System.in);

        double adjacency_matrix[][] = new double[number_of_vertices + 1][number_of_vertices + 1];
        ...
        for (int i = 1; i <= number_of_vertices; i++)
        {
            ...
            {
                adjacency_matrix[i][j] = adjacency_matrix_old[i-1][j-1];
                if (i == j)
                {
